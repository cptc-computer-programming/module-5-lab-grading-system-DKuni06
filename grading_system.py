...
# This file takes a student's assignment information and assigns a letter grade
...
#uses boolean variables to represent logic
...
if extra_credit_completed:
    final_score = final_score + EXTRA_CREDIT
